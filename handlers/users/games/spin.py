    ...
    if flood and flood2:
        ...
        if score_change < 0:
            ...
            return await message.reply(
                f'🎰 Вы умножили свою ставку на (x1.5) и получили +{to_str(summ)} на баланс!\n'
                f'🎰 Комбинация: {str(combo_text).replace(",", " ")}',
                reply_markup=play_spin_kb.as_markup())
        elif score_change == 2:
            summ = int(summ * 2)
            ...
            await asyncio.sleep(2.5)
            return await message.reply(
                f'🎰 Вы умножили свою ставку на (x2) и получили +{to_str(summ)} на баланс!\n'
                f'🎰 Комбинация: {str(combo_text).replace(",", " ")}',
                reply_markup=play_spin_kb.as_markup())
        elif score_change == 3:
            summ = int(summ * 2.5)
            ...
            await asyncio.sleep(2.5)
            return await message.reply(
                f'🎰 Вы умножили свою ставку на (x2.5) и получили +{to_str(summ)} на баланс!\n'
                f'🎰 Комбинация: {str(combo_text).replace(",", " ")}',
                reply_markup=play_spin_kb.as_markup())
        elif score_change == 4:
            summ = int(summ * 3)
            ...
            await asyncio.sleep(2.5)
            return await message.reply(
                f'🎰 Вы умножили свою ставку на (x3) и получили +{to_str(summ)} на баланс!\n'
                f'🎰 Комбинация: {str(combo_text).replace(",", " ")}',
                reply_markup=play_spin_kb.as_markup())
