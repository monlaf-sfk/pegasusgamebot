...
async def help_handler(message: Message):
    ...
    ##########################################ИГРЫ#####################################################
        ...
        return await message.reply(text=actions_help['games'].format(user=user.link)
                                   , disable_web_page_preview=True)
    elif arg[0].lower() == 'загадка':
        return await message.reply(text=f'{user.link}, описание команды:\n'
                                        '❓ Команда «Загадка» присылает случайную загадку.\n'
                                        '➖ Для отправки ответа используйте команду «Ответ [отгадка]».\n'
                                        '➖ Если Вы не знаете правильного ответа введите «Сдаюсь».\n'
                                        '➖ Каждый правильный ответ будет приносить Вам определенную сумму, которая зависит от Вашего уровня.\n'
                                        '❔ Играть в загадки можно и с другими игроками в беседе!\n'
                                   , disable_web_page_preview=True)
    elif arg[0].lower() in ['поле', 'минное поле']:
        return await message.reply(text=f'{user.link}, описание команды:\n'
                                        '💣 Для начала игры в «Минное поле» введите команду «Поле [ставка]»\n'
                                        '➖ Поле имеет размер 3x4 клеток, в одной из клеток каждой строки находится «мина».\n'
                                        '➖ Цель игры - угадать клетку, в которой нет мины: «Поле [номер клетки: 1-3]»\n'
                                        '➖ При правильном выборе Вы переходите на следующую строку, а Ваша ставка умножается.\n'
                                        '💰 Чтобы забрать деньги, введите команду «Поле».\n'
                                   , disable_web_page_preview=True)
    elif arg[0].lower() in ['казино']:
        return await message.reply(text=f'{user.link}, описание команды:\n'
                                        '🎰 Команда «Казино» случайно умножает Вашу ставку на множители: х0, х0.25, х0.5, x0.75, х1.25, х1.5, х1.75, х2 или х3.\n'
                                        '➖ Чтобы поставить всю сумму введите «Казино все» \n'
                                        '❔ Для заработка больших денег придумывайте различные тактики и не ставьте ва-банк слишком часто.\n'
                                   , disable_web_page_preview=True)
    elif arg[0].lower() in ['кубик']:
        return await message.reply(text=f'{user.link}, описание команды:\n'
                                        '🎲 Команда «Кубик» генерирует случайное число от 1 до 6 и сравнивает его с Вашим.\n'
                                        '➖ За каждое угаданное число Вы получаете приз.\n'
                                        '❔ Также можно использовать команду «Куб».\n'
                                   , disable_web_page_preview=True)
    elif arg[0].lower() in ['боулинг']:
        return await message.reply(text=f'{user.link}, описание команды:\n'
                                        '🎳 Для начала игры в «Боулинг» введите команду «Боулинг [ставка]»\n'
                                        '➖ При сбиваний 5 кеглей ставка умножается на 1.25х\n'
                                        '➖ При сбиваний 4 кеглей ставка умножается на 1х\n'
                                        '➖ При сбиваний 3 кеглей  ниже ставка умножается на 0х\n'
                                        '➖ Страйк х3\n'
                                        '💰 Выбросьте шар и сразите все кегли! \n'
                                   , disable_web_page_preview=True)
    elif arg[0].lower() in ['дартс']:
        return await message.reply(text=f'{user.link}, описание команды:\n'
                                        '🎯 Для начала игры в «Дартс» введите команду «Дартс [ставка]»\n'
                                        '➖ Если дротик попал в центр то множитель х3 на круг ниже 2х остальное х0\n'
                                        '💰 Прицельтесь в цель! \n'
                                   , disable_web_page_preview=True)
    elif arg[0].lower() in ['футбол']:
        return await message.reply(text=f'{user.link}, описание команды:\n'
                                        '⚽ Для начала игры в «Футбол» введите команду «Футбол [ставка]»\n'
                                        '➖ При попаданий в центр ворот множитель х1\n'
                                        '➖ При попаданий от штанги ворот множитель х1.25\n'
                                        '➖ При попаданий в девятку множитель х3\n'
                                        '💰 На поле – вы! Взяв мяч, двигайтесь по полю, обходите соперников и забивайте голы! \n'
                                   , disable_web_page_preview=True)
    elif arg[0].lower() in ['баскетбол']:
        return await message.reply(text=f'{user.link}, описание команды:\n'
                                        '🏀️ Для начала игры в «Баскетбол» введите команду «Баскетбол [ставка]»\n'
                                        '➖ Трех очковый множитель х2.5\n'
                                        '➖ При попаданий когда мя крутится вокруг корзины х1\n'
                                        '💰 Выберите правильный угол и силу броска\n'
                                   , disable_web_page_preview=True)
    elif arg[0].lower() in ['спин']:
        return await message.reply(text=f'{user.link}, описание команды:\n'
                                        '🎰 Для начала игры в «Спин» введите команду «Спин [ставка]»\n'
                                        '➖ Комбинация из двух одинаковых подряд множитель x1.5\n'
                                        '<i>Пример:(7️⃣  🍇  🍇),(🍋  🍋  🍇)</i>\n\n'
                                        '➖ Комбинация из двух одинаковых подряд 7 множитель x2\n'
                                        '<i>Пример:(🍋  7️⃣  7️⃣),(7️⃣  7️⃣  🍇)</i>\n\n'
                                        '➖ Комбинация из трех одинаковых подряд множитель x2.5\n'
                                        '<i>Пример:(🍇  🍇  🍇),(🍋  🍋  🍋)</i>\n\n'
                                        '➖ Джекпот комбинация 7️⃣7️⃣7️⃣ множитель x3\n'
                                        '💰 Крутите колесо удачи! \n'
                                   , disable_web_page_preview=True)
    elif arg[0].lower() in ['рулетка']:
        return await message.reply(text=f'{user.link}, описание команды:\n'
                                        '🔫 Команда «Рулетка» запускает игру в «Русскую рулетку».\n'
                                        '6️⃣ Всего можно сделать до 6-ти выстрелов с помощью команды «Выстрел».\n'
                                        '💰 Чтобы забрать деньги и не рисковать, введите команду «Ррулетка» повторно.\n'
                                   , disable_web_page_preview=True)
    ##########################################РАБОТА#####################################################
    ...
    ##########################################ПРОЧЕЕ#####################################################
        ...
        return await message.reply(text=actions_help['other'].format(user=user.link)
                                   , disable_web_page_preview=True)
    elif arg[0].lower() == 'курс':
        return await message.reply(text=f'{user.link}, описание команды:\n'
                                        f'📊 С помощью команды «Курс» можно узнать курс юаня, евро или биткоина на данный момент.'
                                   , disable_web_page_preview=True)
    elif arg[0].lower() == 'шар':
        return await message.reply(text=f'{user.link}, описание команды:\n'
                                        f'🔮 Команда «Шар» использует магию рандома и выводит случайное сообщение.'
                                   , disable_web_page_preview=True)
    elif arg[0].lower() == 'выбери':
        return await message.reply(text=f'{user.link}, описание команды:\n'
                                        f'⚖️ Команда «Выбери» случайным образом выбирает один из двух предложенных вариантов: «Выбери 1 или 2»'
                                   , disable_web_page_preview=True)
    elif arg[0].lower() == 'анекдот':
        return await message.reply(text=f'{user.link}, описание команды:\n'
                                        f'😐 Команда «Анекдот» выдает случайный (чаще всего не смешной) анекдот.'
                                   , disable_web_page_preview=True)
    elif arg[0].lower() == 'переверни':
        return await message.reply(text=f'{user.link}, описание команды:\n'
                                        f'↪️ Команда «Переверни» отправляет Ваш текст вверх ногами.\n'
                                        '➖ Поддерживаются цифры, буквы латинского и кириллического алфавита, а также некоторые символы.\n'
                                   , disable_web_page_preview=True)
    elif arg[0].lower() in ['шанс', 'вероятность']:
        return await message.reply(text=f'{user.link}, описание команды:\n'
                                        f'📊 Команда «Шанс» случайным образом присылает шанс чего-либо.\n'
                                        '❔ Также можно использовать команды «Вероятность».\n'
                                   , disable_web_page_preview=True)
    elif arg[0].lower() == 'реши':
        return await message.reply(text=f'{user.link}, описание команды:\n'
                                        ' 📠 Команда «Реши» решает Ваш пример (Реши 5+5/5*3).\n'
                                        '❔ Команда умеет:\n'
                                        '⠀1️⃣ Складывать (+)\n'
                                        '⠀2️⃣ Вычитать (-)\n'
                                        '⠀3️⃣ Умножать (*)\n'
    ...
    ##########################################УНИКАЛЬНОЕ#####################################################
        ...
        return await message.reply(text=actions_help['unik'].format(user=user.link)
                                   , disable_web_page_preview=True)
    elif arg[0].lower() in ['уведомления']:
        return await message.reply(f"📢 {user.link} c помощью команды «Уведомления» можно включить или "
                                   "отключить уведомления об получении перевода, новых предложениях брака и т.п",
                                   disable_web_page_preview=True)

    elif arg[0].lower() in ['шоп']:
        return await message.reply(
            f"🔫 {user.link} команда «Шоп» выводит список предметов, которые требуются для участия в текущем ограблении."
            , disable_web_page_preview=True)


    elif arg[0].lower() in ['квесты', 'квест']:
        return await message.reply("🎯 Квесты - задания, за выполнение которых Вы будете получать награды.\n"
                                   '➖ Квесты - посмотреть список заданий\n'
                                   '➖ Квесты обновить - заменить текущие квесты новыми (доступно раз в день)\n',
                                   disable_web_page_preview=True)
